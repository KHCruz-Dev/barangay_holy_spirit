...
router.post("/:id/photo", upload.single("photo"), async (req, res) => {
  try {
    ...
    const key = `non_residents/${id}.jpg`;
    ...
    const updated = await saveNonResidentPhoto(id, {
      img_url: imageUrl,
      img_mime: "image/jpeg",
    });
    ...
    res.json({
      ...
      nonResidentsProfile: updated,
    });
  } catch (error) {
    console.error("Non-resident photo upload error:", error);
